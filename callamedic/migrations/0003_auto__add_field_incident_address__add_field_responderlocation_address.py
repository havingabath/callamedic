...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Incident.address'
        db.add_column('callamedic_incident', 'address', self.gf('django.db.models.fields.CharField')(max_length=300, null=True), keep_default=False)

        # Adding field 'ResponderLocation.address'
        db.add_column('callamedic_responderlocation', 'address', self.gf('django.db.models.fields.CharField')(max_length=300, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Incident.address'
        db.delete_column('callamedic_incident', 'address')

        # Deleting field 'ResponderLocation.address'
        db.delete_column('callamedic_responderlocation', 'address')
