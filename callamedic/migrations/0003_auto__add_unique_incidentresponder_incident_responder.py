...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'IncidentResponder', fields ['incident', 'responder']
        db.create_unique('callamedic_incidentresponder', ['incident_id', 'responder_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'IncidentResponder', fields ['incident', 'responder']
        db.delete_unique('callamedic_incidentresponder', ['incident_id', 'responder_id'])
    ...
    models = {
        ...
        'callamedic.incidentresponder': {
            'Meta': {'unique_together': "(['responder', 'incident'],)", 'object_name': 'IncidentResponder'},
