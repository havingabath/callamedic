...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ResponderLocation.latest'
        db.add_column('callamedic_responderlocation', 'latest', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ResponderLocation.latest'
        db.delete_column('callamedic_responderlocation', 'latest')
